...
def download_contract_from_quandl(contract, dl_dir):
    ...
    # params = "?auth_token=M3S6cLgQ3b_czSDmKJxD&sort_order=asc"
...
def create_check(dirName):
    """
    Create target directory & all intermediate 
    directories if don't exists
    """
...
if __name__ == "__main__":
    ...
    symbol = 'EIA'
    dl_dir = 'quandl/futures/' + str(symbol)
    ...
    # # es = pd.io.parsers.read_csv("%s/ICEH2010.csv" % dl_dir, index_col="Date")
    # # es["Settle"].plot()
    # # plt.show()
   

    
# M3S6cLgQ3b_czSDmKJxD
